...
LINUX_FLASH_STRUCT linuxFlash =
						{
							UBOOT_OFFSET,	/* boot loader 	*/
							MAC_OFFSET,	/* mac address	*/
							PIN_OFFSET,	/* pin address	*/
							KERNEL_OFFSET,	/* kernel		*/
							ROOTFS_OFFSET,	/* root fs		*/
...
int do_bootm (cmd_tbl_t *cmdtp, int flag, int argc, char *argv[])
{
	...
	memcpy(&kernelTextAddr, ((char *)addr)+116, sizeof(ulong));
	memcpy(&kernelEntryPoint, ((char *)addr)+120, sizeof(ulong));
	memcpy(&kernelLen, ((char *)addr)+132, sizeof(ulong));
	...
	//TODO :check magic number and checksum in file_tag
	show_boot_progress (2);
